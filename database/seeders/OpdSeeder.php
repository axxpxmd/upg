...
class OpdSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $opds = [
            ...
            ['n_opd' => 'BPBD Kota Tanngerang Selatan', 'alamat' => 'jl. Cendekia No.28 kel. Ciater kec. Serpong'],
            ['n_opd' => 'Dinas Pemadam Kebakaran dan Penyelamatan', 'alamat' => 'Jl. Melatimas raya blok J no.3. Kec. Serpong Utara - Kel. Pondok Jagung. Tangerang Selatan'],
        ];
