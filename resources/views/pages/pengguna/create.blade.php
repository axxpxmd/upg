...
@section('content')
    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-2">Tambah Pengguna Baru</h1>
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Isi formulir di bawah untuk menambahkan pengguna baru</p>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        <form action="{{ route('pengguna.store') }}" method="POST" class="p-6 sm:p-8">
            @csrf
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="username" name="username" value="{{ old('username') }}" required placeholder="Contoh: john.doe atau admin123"
                    ...
                    <div>
                        ...
                        <input type="text" id="nik" name="nik" value="{{ old('nik') }}" inputmode="numeric" pattern="[0-9]{16}" maxlength="16" placeholder="Contoh: 3674012301850001"
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama') }}" required placeholder="Contoh: John Doe Wijaya"
                    ...
                    <div>
                        ...
                        <input type="text" id="jabatan" name="jabatan" value="{{ old('jabatan') }}" required placeholder="Contoh: Staff IT, Kepala Bidang Data"
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="Contoh: john.doe@tangsel.go.id"
                    ...
                    <div>
                        ...
                        <input type="text" id="no_hp" name="no_hp" value="{{ old('no_hp') }}" placeholder="Contoh: 08123456789"
            ...
            <div class="mb-8">
                ...
                <div>
                    ...
                    <div class="mt-3 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                        <p class="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-2">Password harus memenuhi kriteria:</p>
                        <ul class="space-y-1.5">
                            <li id="req-length" class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                                <i data-lucide="circle" class="w-3 h-3"></i>
                                <span>Minimal 12 karakter</span>
                            </li>
                            <li id="req-uppercase" class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                                <i data-lucide="circle" class="w-3 h-3"></i>
                                <span>Minimal satu huruf besar (A-Z)</span>
                            </li>
                            <li id="req-lowercase" class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                                <i data-lucide="circle" class="w-3 h-3"></i>
                                <span>Minimal satu huruf kecil (a-z)</span>
                            </li>
                            <li id="req-number" class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                                <i data-lucide="circle" class="w-3 h-3"></i>
                                <span>Minimal satu angka (0-9)</span>
                            </li>
                            <li id="req-special" class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                                <i data-lucide="circle" class="w-3 h-3"></i>
