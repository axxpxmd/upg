...
@section('content')
    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-2">Edit Indikator</h1>
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Perbarui data indikator</p>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        <form action="{{ route('indikator.update', $indikator->id) }}" method="POST" class="p-6 sm:p-8">
            @csrf
            @method('PUT')
            ...
            <div class="mb-8">
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_indikator" name="nama_indikator" value="{{ old('nama_indikator', $indikator->nama_indikator) }}" required placeholder="Contoh: Tingkat Kepatuhan Pelaporan"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="periode_id" name="periode_id" required
                                ...
                                @foreach($periodes as $periode)
                                    <option value="{{ $periode->id }}" {{ old('periode_id', $indikator->periode_id) == $periode->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="number" id="bobot_persen" name="bobot_persen" value="{{ old('bobot_persen', $indikator->bobot_persen) }}" step="0.01" min="0" max="100" placeholder="Contoh: 25.5"
