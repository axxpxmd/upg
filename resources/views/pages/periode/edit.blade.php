...
@section('content')
    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-2">Edit Periode</h1>
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Perbarui data periode</p>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        <form action="{{ route('periode.update', $periode->id) }}" method="POST" class="p-6 sm:p-8">
            @csrf
            @method('PUT')
            ...
            <div class="mb-8">
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="tahun" name="tahun" value="{{ old('tahun', $periode->tahun) }}" required min="2000" max="2100" placeholder="Contoh: {{ date('Y') }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="tgl_mulai" name="tgl_mulai" value="{{ old('tgl_mulai', $periode->tgl_mulai ? \Carbon\Carbon::parse($periode->tgl_mulai)->format('Y-m-d\TH:i') : '') }}"
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="tgl_selesai" name="tgl_selesai" value="{{ old('tgl_selesai', $periode->tgl_selesai ? \Carbon\Carbon::parse($periode->tgl_selesai)->format('Y-m-d\TH:i') : '') }}"
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $periode->is_active) ? 'checked' : '' }} class="sr-only peer">
